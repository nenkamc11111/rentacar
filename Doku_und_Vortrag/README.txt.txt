...
•
Logs werden in STDOUT/ERR geschrieben  
•
...
•
Konfiguration via Umgebungsvariablen------> OK in Spring boot Admin
•
Health/Info endpoint------> OK in Spring boot Admin
•
Graceful shutdown
•
Connection zu Datenbank regulär geprüft---- > OK DB PostgrSql 
•
